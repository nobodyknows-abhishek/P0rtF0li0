...
export default function Overlay({ containerRef }: { containerRef: RefObject<HTMLDivElement> }) {
  ...
  const x2 = useTransform(scrollYProgress, [0.3, 0.4, 0.5, 0.6], [-50, 0, 0, 50]);
  ...
  const y3 = useTransform(scrollYProgress, [0.65, 0.75, 0.85, 0.95], [100, 0, 0, -100]);
  const x3 = useTransform(scrollYProgress, [0.65, 0.75, 0.85, 0.95], [50, 0, 0, -50]);
      ...
      <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center p-6 md:p-24 text-white overflow-hidden">
        ...
        >
          <h2 className="text-3xl sm:text-5xl md:text-7xl xl:text-[6rem] font-bold tracking-tighter leading-[1.1] drop-shadow-2xl">
            I build <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-indigo-500 italic font-medium font-serif">scalable apps.</span>
          </h2>
        </motion.div>
        ...
        >
          <h2 className="text-3xl sm:text-5xl md:text-7xl xl:text-[6rem] font-bold tracking-tighter leading-[1.1] drop-shadow-2xl">
            Bridging <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-l from-rose-400 to-orange-400">front-end &amp; backend.</span>
          </h2>
        </motion.div>
